...
ESC_JSSDK.Printer.prototype.setPrintData = function (data) {
    this.data = data;
};
...
ESC_JSSDK.Printer.prototype.print = function () {
    ...
    return senddata(ip, port, model,this.data,interfacePort,tag,tag_port);
    // senddata(ip, port, model,this.data,interfacePort);
}
...
ESC_JSSDK.Builder.prototype.getPrintData = function () {
...
//4.9
ESC_JSSDK.Builder.prototype.GetPrinterState = function () {
    var d = "{";
...
ESC_JSSDK.Builder.prototype.DefineNVImageCompatible = function (fileNameList,imageQty) {
    ...
    d += createStr("fileNameList", fileNameList);			//图片名之间用分号分隔
...
//add by wjz 20210528
ESC_JSSDK.Builder.prototype.DirectIO = function (readNum, customid, datatype, converttype, writedata) {
    var d = "{";
